...
export class EventControllerService {
  ...
  public createEventUsingPOST(
    eventRequest: EventVO,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<EventVO>>;
  public createEventUsingPOST(
    eventRequest: EventVO,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<EventVO>>;
  public createEventUsingPOST(
    eventRequest: EventVO,
    observe: any = 'body',
    ...
    return this.httpClient.post<EventVO>(`${this.basePath}/api/v1/event`, eventRequest, {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public filterEventsUsingGET(
    fromUserId?: string,
    toUserId?: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<EventVO>>;
  public filterEventsUsingGET(
    fromUserId?: string,
    toUserId?: string,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<EventVO>>>;
  public filterEventsUsingGET(
    fromUserId?: string,
    toUserId?: string,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<EventVO>>>;
  public filterEventsUsingGET(
    fromUserId?: string,
    toUserId?: string,
    observe: any = 'body',
