...
export class TransactionControllerService {
   ...
   */
  public deleteTransactionByIdUsingDELETE(
  ...
  public deleteTransactionByIdUsingDELETE(
    ...
    if (transactionId === null || transactionId === undefined) {
      throw new Error(
        'Required parameter transactionId was null or undefined when calling deleteTransactionByIdUsingDELETE.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/api/v1/transaction/${encodeURIComponent(String(transactionId))}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getTransactionsUsingGET(
    owedBy?: string,
    owedTo?: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<TransactionVO>>;
  public getTransactionsUsingGET(
    owedBy?: string,
    owedTo?: string,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<TransactionVO>>>;
  public getTransactionsUsingGET(
    owedBy?: string,
    owedTo?: string,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<TransactionVO>>>;
  public getTransactionsUsingGET(
    owedBy?: string,
    owedTo?: string,
    observe: any = 'body',
