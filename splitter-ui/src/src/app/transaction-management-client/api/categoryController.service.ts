...
export class CategoryControllerService {
     ...
     */
    public findAllUsingGET(observe?: 'body', reportProgress?: boolean): Observable<Array<Category>>;
    public findAllUsingGET(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Category>>>;
    public findAllUsingGET(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Category>>>;
    public findAllUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Category>>(`${this.basePath}/api/category`,
            {
