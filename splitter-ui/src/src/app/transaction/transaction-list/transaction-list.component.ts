...
export class TransactionListComponent implements OnInit {
  ...
  constructor(private credentialService: CredentialsService, private eventControllerService: EventControllerService) {
    this.userMobileNo = this.credentialService.credentials.username;
  }

  ngOnInit(): void {
    this.eventControllerService
      .filterEventsUsingGET(this.credentialService.credentials.username, this.credentialService.credentials.username)
      .subscribe((events) => {
        this.events = events;
